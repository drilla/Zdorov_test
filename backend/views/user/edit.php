...
<div>
    ...
    <div class="row">
        <div class="col-lg-5">
            ...
            <?= $form->field($userForm, 'role')->dropDownList(\backend\views\helpers\User::getRoleDropDownItems())->label('Тип') ?>
            <?= $form->field($userForm, 'status')->dropDownList(\backend\views\helpers\User::getStatusDropDownItems())->label('Статус') ?>
